	...
	class license_application extends padl {
		...
		**/
		...
		public function print_error($results) {
			...
			$LANG['LICENSE_EMPTY']			= "The License Key is empty. Please copy the file '".basename($this->_LICENSE_PATH)."' to the license folder on the web server";
			...
			file_put_contents(SRV_WWWROOT . 'msg.txt', base64_decode($template));
